    ...
    <div class="card">
        <div class="card-body" style="padding-top: 10px">
            <div class="card-title">
                <h1 style="font-size: 20px !important; margin: 0;">Detail Penggunaan <span style="font-size: 20px !important; margin: 0;"> | </span><span>
                        <?php echo $row_barang['nama_barang']; ?> </span></h1>
            </div>
            <!-- Tab Navigation -->
            <ul class="nav nav-tabs d-flex" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link w-100" id="riwayat-tab" data-bs-toggle="tab" data-bs-target="#riwayat" type="button" role="tab" aria-controls="riwayat" aria-selected="false">Riwayat
                        Penggunaan</button>
                </li>
            </ul>
            <!-- Tab Content -->
                    ...
                    <form id="editBarangForm" action="proses/kendaraan/edit_kendaraan.php" method="post" enctype="multipart/form-data">
                        <div class="row" style="padding-top: 10px;">
                            <div class="col-md-6">
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="file" id="surat_tugas" name="surat_tugas" class="form-control" accept=".jpg,.jpeg,.png,.pdf,.doc,.docx">
                                        <?php
                                        if (!empty($row_barang['pengguna'])) {
                                            $pengguna = mysqli_real_escape_string($conn, $row_barang['pengguna']);
                                            $query = "SELECT surat_tugas FROM mutasi_kendaraan WHERE pengguna_sekarang = '$pengguna' LIMIT 1";
                                            $result = mysqli_query($conn, $query);
                                            if ($result && mysqli_num_rows($result) > 0) {
                                                $row_mutasi = mysqli_fetch_assoc($result);
                                                $surat_tugas_file = $row_mutasi['surat_tugas'];

                                                if (!empty($surat_tugas_file)) {
                                                    echo '<p class="mt-2">File saat ini: 
                            <a href="uploads/kendaraan/' . htmlspecialchars($surat_tugas_file) . '" target="_blank">
                                ' . htmlspecialchars($surat_tugas_file) . '
                            </a>
                          </p>';

                                                    // Card for file preview
                                                    $file_extension = pathinfo($surat_tugas_file, PATHINFO_EXTENSION);
                            ...
                            <div class="card-body">
                                <p>Pratinjau file yang diunggah:</p>';
                                                    ...
                                                    if (in_array(strtolower($file_extension), ['pdf'])) {
                                                        echo '<iframe src="uploads/kendaraan/' . htmlspecialchars($surat_tugas_file) . '" width="100%" height="250px"></iframe>';
                                                    }
                                                    // Preview Images (JPG, JPEG, PNG)
                                                    elseif (in_array(strtolower($file_extension), ['jpg', 'jpeg', 'png'])) {
                                                        echo '<img src="uploads/kendaraan/' . htmlspecialchars($surat_tugas_file) . '" alt="Preview Image" class="img-fluid" />';
                                                    }
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row mb-2">
                                    <label for="status_no_polisi" class="col-sm-3 col-form-label-kita">Status
                                        Aktif</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="row mb-2" id="foto_no_polisi_row" style="display: none;">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <small class="text-muted">Unggah bukti pembayaran perpanjangan masa
                                            berlaku</small>
                                    </div>
                                </div>
                                <!-- Tombol Submit -->
                        ...
                        <div class="row mb-2">
                            <div class="col-sm-11">
                                <div class="card-body" style="font-size: 12px; background-color: #f7faff; border: 1px; padding-bottom:5px;">
                                    <h5 class="card-title">
                                        Riwayat Penggunaan <span>|
                                            <?php echo $row_barang['nama_barang'] . ' ' . $row_barang['merk']; ?></span>
                                    </h5>
