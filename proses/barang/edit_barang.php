...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($_FILES['foto_barang']) && $_FILES['foto_barang']['error'] === UPLOAD_ERR_OK) {
        ...
        $target_dir = "../../assets/images/"; // Adjust path according to your directory structure
    ...
    if (mysqli_query($conn, $sql_update)) {
        ...
        if ($ruang_sekarang_sebelum !== $id_ruang_sekarang) {
            ...
            $ruang_asal_nama = $row_ruang_asal['id_lokasi'] . ' - ' . $row_ruang_asal['bid_lokasi'];
            ...
            $ruang_sekarang_nama = $row_ruang_sekarang['id_lokasi'] . ' - ' . $row_ruang_sekarang['bid_lokasi'];
        ...
        header('Location: ../../detail_barang.php?id_barang_pemda=' . $id_barang_pemda);
        exit;
    } else {
