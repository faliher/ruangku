...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // Prepare SQL query
    $stmt = $conn->prepare("INSERT INTO lokasi (id_lokasi, nama_lokasi, bid_lokasi, tempat_lokasi, desk_lokasi) VALUES (?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("ssssss", $id_lokasi, $nama_lokasi, $bid_lokasi, $tempat_lokasi, $desk_lokasi);
