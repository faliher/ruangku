                    ...
                    <tbody>
                        <tr>
                            <td rowspan="4" class="brebes-img" style="vertical-align: middle;">
                                ...
                                <br>
                                <span style="font-size: 8px; margin-top: 5px; display: inline-block;"><?php echo date('Y'); ?></span>
                            </td>
                            <td colspan="2" class="kode-barang" style="padding-bottom:3px; font-size: 10px;"><?php echo $id_barang_pemda; ?></td>
                            <td rowspan="4" style="vertical-align: middle; width: 70px; height: 70px;">
                                <img src="<?php echo $filename; ?>" alt="QR Code" class="qrcode">
                            </td>
                        </tr>
                        <tr>
                            <td colspan="2" class="kode-barang" style="vertical-align: top; font-size: 10px;"><?php echo $kode_barang; ?></td>
                        </tr>
                        <tr>
                            <td colspan="2" style=" font-size: 10px; text-align: left; height:20px; padding-left: 5px"><?php echo $nama_barang; ?></td>
                        </tr>
                        <tr>
                            <td style="text-align: left; font-size: 9px; padding-left: 5px">
                                <?php
                                echo date('d-m-Y', strtotime($tgl_pembelian));
                                ?>
                            </td>

                            <td style="font-size: 9px;"><?php echo $no_regristrasi; ?></td>
                        </tr>
                    </tbody>
                </table>
            </div>
