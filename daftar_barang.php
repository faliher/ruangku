                ...
                if (mysqli_num_rows($result) > 0) {
                  while ($row = mysqli_fetch_assoc($result)) {
                    echo "<tr class='text-center'>
                      ...
                      <td><a href='data_barang.php?id_barang_pemda={$row['id_barang_pemda']}' class='text-primary'>Detail</a></td>
                    </tr>";
                  }
                } else {
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <td><a href='data_barang.php?id_barang_pemda={$row_kurang['id_barang_pemda']}' class='text-primary'>Detail</a></td>
            </tr>";
                }
              } else {
                echo "<tr><td colspan='7' class='text-center'>Tidak ada data yang ditemukan.</td></tr>";
        ...
        <div class="table-responsive">
          <table class="table table-bordered">
            ...
            <tbody>
              ...
              <td><a href='data_barang.php?id_barang_pemda={$row_rusak['id_barang_pemda']}' class='text-primary'>Detail</a></td>
            </tr>";
                }
              } else {
                echo "<tr><td colspan='7' class='text-center'>Tidak ada data yang ditemukan.</td></tr>";
